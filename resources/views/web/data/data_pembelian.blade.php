...
@section('main')
    <section class="pt-2 container pb-5">
        <div class="card text-center border-2" style="background-color: #007bff;">
            <div class="card-body">
                <h2 class="card-title" style="color: #FFFFFF;">Data Pembelian</h2>
                <h4 class="card-text text-body-secondary" style="color: #FFFFFF;">Halaman Data Pembelian</h4>
            </div>
        </div>
                            ...
                            @foreach ($data_pembelian as $items)
                                ...
                                <tr>
                                    ...
                                    @switch($items->pembelian_status)
                                        @case ('beli')
                                            <td><button type="button" class="btn btn-outline-warning btn-sm w-100" style="background-color: #007bff; color: #FFFFFF;">Beli</button>
                                            </td>
                                        @break

                                        @case ('proses')
                                            <td><button type="button" class="btn btn-outline-info btn-sm w-100" style="background-color: #007bff; color: #FFFFFF;">Proses</button>
                                            </td>
                                        @break

                                        @case ('selesai')
                                            <td><button type="button" class="btn btn-outline-success btn-sm w-100" style="background-color: #007bff; color: #FFFFFF;">Selesai</button>
                                            </td>
                                        @break

                                        @case ('batal')
                                            <td><button type="button" class="btn btn-outline-danger btn-sm w-100" style="background-color: #007bff; color: #FFFFFF;">Batal</button>
                                            </td>
                                        @break

                                        @default
                                            <td><button type="button" class="btn btn-outline-danger btn-sm w-100" style="background-color: #007bff; color: #FFFFFF;">Kesalahan Data</button></td>
                                        @break
                                    @endswitch
                                                    ...
                                                    @foreach ($details as $detail)
                                                        ...
                                                        <li
                                                            ...
                                                            <span class="badge rounded-pill"
                                                                style="background-color: #8423ff; color: #FFFFFF;">Jumlah :
