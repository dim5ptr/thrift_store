...
<nav class="navbar shadow-xl navbar-expand-lg" style="background-color: #00008B;">
    <div class="container-fluid">
        <a class="navbar-brand" href="{{ route('dashboard') }}"><img width="60px" src="{{ asset('img/logo.png') }}" style="filter: invert(1);"></a>
